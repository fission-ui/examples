...
#[allow(dead_code)]
pub static RUSTC: &str = "/Users/ola/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/Users/ola/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc";
...
#[doc=r#"The output of `/Users/ola/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.93.0 (254b59607 2026-01-19)";
#[doc=r#"The output of `/Users/ola/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/ola/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
